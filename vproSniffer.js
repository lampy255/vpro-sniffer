...
webServer.listen(settings.webPort, () => {
    ...
    console.log("Open a web browser to http://127.0.0.1:" + settings.webPort + "/web/live-1.html");
    console.log("Replace the 'live-1' with whatever signal you want to monitor.");
});
...
if (settings.wsOnStart) {
    if (settings.frameDiscardInterval > 9) {
        ...
        console.log("Error: Frame Discard interval too low.");
    }
} else {
    console.log("Not starting WS.");
}
